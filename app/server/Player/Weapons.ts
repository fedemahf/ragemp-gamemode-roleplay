...
class Weapons {
    ...
    protected names = (type: string): string | undefined => {
        ...
        mp.events.addCommand({
            'weapon': (player: PlayerMp, fullText: string, weaponType: string, weaponName: string) => {
                ...
                if (!fullText || !weaponType) {
                    ...
                    let weaponTypeSelected: object = this.list[weaponType.toLowerCase()];
                    ...
                    if (!weaponTypeSelected) {
                        ...
                        if (!weaponName) {
                            ...
                            let weaponNameSelected: string = weaponTypeSelected[weaponName.toLowerCase()];
