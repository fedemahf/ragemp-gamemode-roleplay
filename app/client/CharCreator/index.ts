...
function fillHairMenu() {
    hairItem = new NativeUI.UIMenuListItem("Hair", "Your character's hair.", new NativeUI.ItemsCollection(Data.hairList[currentGender].map(h => h.Name)));
    creatorHairMenu.AddItem(hairItem);

    hairColorItem = new NativeUI.UIMenuListItem("Hair Color", "Your character's hair color.", new NativeUI.ItemsCollection(hairColors));
    creatorHairMenu.AddItem(hairColorItem);

    hairHighlightItem = new NativeUI.UIMenuListItem("Hair Highlight Color", "Your character's hair highlight color.", new NativeUI.ItemsCollection(hairColors));
    creatorHairMenu.AddItem(hairHighlightItem);

    eyebrowColorItem = new NativeUI.UIMenuListItem("Eyebrow Color", "Your character's eyebrow color.", new NativeUI.ItemsCollection(hairColors));
    creatorHairMenu.AddItem(eyebrowColorItem);

    beardColorItem = new NativeUI.UIMenuListItem("Facial Hair Color", "Your character's facial hair color.", new NativeUI.ItemsCollection(hairColors));
    creatorHairMenu.AddItem(beardColorItem);

    eyeColorItem = new NativeUI.UIMenuListItem("Eye Color", "Your character's eye color.", new NativeUI.ItemsCollection(Data.eyeColors));
    creatorHairMenu.AddItem(eyeColorItem);

    blushColorItem = new NativeUI.UIMenuListItem("Blush Color", "Your character's blush color.", new NativeUI.ItemsCollection(blushColors));
    creatorHairMenu.AddItem(blushColorItem);

    lipstickColorItem = new NativeUI.UIMenuListItem("Lipstick Color", "Your character's lipstick color.", new NativeUI.ItemsCollection(lipstickColors));
    creatorHairMenu.AddItem(lipstickColorItem);

    chestHairColorItem = new NativeUI.UIMenuListItem("Chest Hair Color", "Your character's chest hair color.", new NativeUI.ItemsCollection(hairColors));
    creatorHairMenu.AddItem(chestHairColorItem);

    creatorHairMenu.AddItem(new NativeUI.UIMenuItem("Randomize", "~r~Randomizes your hair & colors."));
    creatorHairMenu.AddItem(new NativeUI.UIMenuItem("Reset", "~r~Resets your hair & colors."));
}
...
creatorMainMenu.AddItem(new NativeUI.UIMenuItem("Features", "Your character's facial features."));
...
let creatorParentsMenu = new NativeUI.Menu("Parents", "", new NativeUI.Point(50, 50));
let fatherItem = new NativeUI.UIMenuListItem("Father", "Your character's father.", new NativeUI.ItemsCollection(Data.fatherNames));
let motherItem = new NativeUI.UIMenuListItem("Mother", "Your character's mother.", new NativeUI.ItemsCollection(Data.motherNames));
let similarityItem = new NativeUI.UIMenuListItem("Resemblance", "Similarity to parents.\n(lower = feminine, higher = masculine)", new NativeUI.ItemsCollection(similarities));
let skinSimilarityItem = new NativeUI.UIMenuListItem("Skin Tone", "Skin color similarity to parents.\n(lower = mother's, higher = father's)", new NativeUI.ItemsCollection(similarities));
...
creatorParentsMenu.AddItem(new NativeUI.UIMenuItem("Randomize", "~r~Randomizes your parents."));
creatorParentsMenu.AddItem(new NativeUI.UIMenuItem("Reset", "~r~Resets your parents."));
...
let creatorFeaturesMenu = new NativeUI.Menu("Features", "", new NativeUI.Point(50, 50));

for (let i = 0; i < Data.featureNames.length; i++) {
    let tempFeatureItem = new NativeUI.UIMenuListItem(Data.featureNames[i], "", new NativeUI.ItemsCollection(features));
    tempFeatureItem.Index = 100;
    featureItems.push(tempFeatureItem);
    creatorFeaturesMenu.AddItem(tempFeatureItem);
}

creatorFeaturesMenu.AddItem(new NativeUI.UIMenuItem("Randomize", "~r~Randomizes your features."));
creatorFeaturesMenu.AddItem(new NativeUI.UIMenuItem("Reset", "~r~Resets your features."));
...
let creatorAppearanceMenu = new NativeUI.Menu("Appearance", "", new NativeUI.Point(50, 50));
...
for (let i = 0; i < Data.appearanceNames.length; i++) {
    ...
    let tempAppearanceOpacityItem = new NativeUI.UIMenuListItem(Data.appearanceNames[i] + " Opacity", "", new NativeUI.ItemsCollection(opacities));
...
creatorAppearanceMenu.AddItem(new NativeUI.UIMenuItem("Randomize", "~r~Randomizes your appearance."));
creatorAppearanceMenu.AddItem(new NativeUI.UIMenuItem("Reset", "~r~Resets your appearance."));
...
creatorHairMenu = new NativeUI.Menu("Hair & Colors", "", new NativeUI.Point(50, 50));
fillHairMenu();
...
mp.events.add("toggleCreator", (active, charData) => {
    if (active) {
        ...
        if (charData) {
            ...
            similarityItem.Index = (charData.Parents.Similarity * 100);
            skinSimilarityItem.Index = (charData.Parents.SkinSimilarity * 100);
            updateParents();
